...
export const translations: Translations = {
  ...
  mr: {
    ...
    pendingApprovalDescription: 'तुमची नोंदणी यशस्वीरित्या सबमिट झाली आहे. तुमचे खाते सध्या मेस ��्यवस्थापकाकडून मंजुरीच्या प्रतीक्षेत आहे.',
    ...
    sidebar_settings: 'सेट���ंग्ज',
    sidebar_logout: 'लॉगआउट',
    sidebar_admin_oversight: 'देखरेख',
    sidebar_admin_viewMenu: 'मेनू पहा',
    // Student Dashboard
    welcomeUser: 'स्वागत आहे, {name}!',
    studentDashboardDescription: 'तुमच्या मेस खात्याचा एक छोट���सा आढावा येथे आहे.',
    dashboardItem_weeklyMenu_title: 'साप्ताहिक मेनू',
    dashboardItem_weeklyMenu_description: 'या आठवड्या�� काय बनवले जात आहे ते पहा.',
    ...
    noNotifications: 'तुमच्यासाठी कोणत्याही नवीन ��ूचना नाहीत.',
    // Student Mess Rules
  ...
  hi: {
    ...
    // PendingApprovalPage
    pendingApprovalTitle: 'सत्या��न लंबित है',
    pendingApprovalDescription: 'आपका पंजीकरण सफलता��ूर्वक सबमिट हो गया है। आपका खाता वर्तमान में मेस प्रबंधक से अनुमोदन की प्रतीक्षा कर रहा है।',
    ...
    fetchMenuError: 'मेन्यू लाने में वि��ल। प्रबंधक ने शायद इसे अभी तक सेट नहीं किया है।',
    // Student My Dues
    ...
    noPastComplaints: '��पकी कोई पिछली शिकायत नहीं है।',
