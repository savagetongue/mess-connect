...
const translations: Translations = {
  ...
  mr: {
    ...
    close: 'बंद करा',
    // HomePage
    appSlogan: 'तुमचे दैनंदिन जेवण व्यवस्थापन, सोपे क���ले.',
    ...
    guestPaymentLink: 'अत��थी म्हणून पैसे द्या',
    // RegisterPage
    ...
    // PendingApprovalPage
    pendingApprovalTitle: 'पडताळणी ��्रलंबित',
    pendingApprovalDescription: 'तुमची नोंदणी यशस्वीरित्या सबमिट झाली आहे. तुमचे खाते सध्या मेस व्यवस्थापकाकडून मंजुरीच्या प्र��ीक्षेत आहे.',
    ...
    sidebar_updateMenu: 'मेनू अपडे�� करा',
    ...
    dashboardItem_giveSuggestion_description: 'आमची सेवा सुधारण्यासाठी काही ��ल्पना आहे का?',
    goToPage: '{page} वर जा',
    // Student Weekly Menu
    ...
    // Student Complaints
    submitNewComplaintTitle: 'नवीन तक्रार सबमिट ��रा',
    submitNewComplaintDescription: 'गैरसोयीबद्दल ��म्ही दिलगीर आहोत. कृपया तुमची समस्या सांगा.',
    ...
    pastComplaintsDescription: 'तुम्ही ��ूर्वी सबमिट केलेल्या तक्रारींची यादी येथे आहे.',
    ...
    // Student Suggestions
    submitSuggestionTitle: 'सूचना ��बमिट करा',
    ...
    notificationsDescription: 'व्यवस्थापकाकडून महत्त्वाचे स��देश आणि अद्यतने.',
  ...
  hi: {
    ...
    close: 'बंद करें',
    // HomePage
    appSlogan: '��पका दैनिक भोजन प्रबंधन, सरलीकृत।',
    ...
    registerDescription: 'मेस में शामिल होने के लिए अपन��� खाता बनाएं।',
    ...
    pendingApprovalDescription: 'आ��का पंजीकरण सफलतापूर्वक सबमिट हो गया है। आपका खाता वर्तमान में मेस प्रबंधक से अनुमोदन की प्रतीक्षा कर रहा है।',
    ...
    dashboardItem_myDues_description: 'अपना भुगतान इतिहास और वर्तमान ��काया देखें।',
    ...
    dashboardItem_giveSuggestion_description: 'हमारी सेवा को बेहतर बना��े के लिए कोई विचार है?',
    ...
    currentMonthDue: 'चालू माह क��� बकाया',
    ...
    pastComplaintsDescription: 'यहाँ आपकी पहले सबमिट की गई शिकायतो�� की सूची है।',
