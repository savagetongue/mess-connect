...
export const translations: Translations = {
  ...
  mr: {
    ...
    payNowButton: 'आता पैसे द���या',
    processingButton: 'प्रक्रिया होत आहे...',
    // PendingApprovalPage
    pendingApprovalTitle: 'पडताळणी प्रलंबित',
    pendingApprovalDescription: 'तुमची नोंदणी यशस्वीरित्या सबमिट झाली आहे. तुमचे खाते सध्या मेस व्यवस्थापकाकडून ��ंजुरीच्या प्रतीक्षेत आहे.',
    ...
    dashboardItem_weeklyMenu_description: 'या आठवड्यात काय बनवले जात आहे ते ��हा.',
    ...
    dashboardItem_raiseComplaint_description: 'काही समस्या आहे का? आम्ह��ला कळवा.',
    ...
    // Student Complaints
    submitNewComplaintTitle: 'नवीन तक्रार ��बमिट करा',
    ...
    notificationsDescription: 'व्यवस्थापकाकडून महत्त���वाचे संदेश आणि अद्यतने.',
  ...
  hi: {
    ...
    studentLoginTitle: 'छात्र ��ॉगिन',
    managerLoginTitle: 'प्रबंधक लॉगिन',
    adminLoginTitle: 'प्रशासक लॉगिन',
    loginDescription: 'अपने डैशबोर्ड तक पहुंचने के लिए अपनी क��रेडेंशियल दर्ज करें।',
    emailLabel: 'ईमेल',
    emailPlaceholder: 'name@example.com',
    passwordLabel: 'पासवर्ड',
    passwordPlaceholder: '••••••••',
    ...
    registerHere: 'यहाँ प��जीकरण करें',
    ...
    pendingApprovalDescription: 'आपका पंजीकरण सफलता��ूर्वक सबमिट हो गया है। आपका खाता वर्तमान में मेस प्रबंधक से अनुमोदन की प्रतीक्षा ��र रहा है।',
    ...
    fetchMenuError: 'मेन्यू लाने में विफल। प्रबंधक ने शायद इसे अभी तक सेट नहीं ��िया है।',
    // Student My Dues
    myDuesTitle: 'मेरे बकाया और भुगतान इतिहास',
    myDuesDescription: 'अपने भुगतान इतिहास की सम���क्षा करें और बकाया राशि का निपटान करें।',
    ...
    submitNewComplaintDescription: 'असु��िधा के लिए हमें खेद है। कृपया अपनी समस्या का वर्णन करें।',
    ...
    // Student Mess Rules
    messRulesTitle: 'मेस के नियम ��र विनियम',
    messRulesDescription: 'कृपया एक सुखद भोजन वातावरण बनाए रखने के लिए निम्नलिखित नियमों का पालन करें।',
    noRulesSet: 'प्रबंधक द्वारा अभी तक कोई नियम नि��्धारित नहीं किया गया है।',
  },
};